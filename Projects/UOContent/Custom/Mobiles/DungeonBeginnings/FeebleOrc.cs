...
namespace Server.Mobiles
{
    ...
    public partial class FeebleOrc : BaseCreature
    {
        [Constructible]
        public FeebleOrc() : base(AIType.AI_Melee)
        {
            //Name = NameList.RandomName("feeble orc");
            Body = 17;
            BaseSoundID = 0x45A;
        ...
        public override string DefaultName => "a feeble orc";
